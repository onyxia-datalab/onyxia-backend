...
func decodeSchemasCatalogIdPackageNamePackageNameVersionsVersionGetResponse(resp *http.Response) (res SchemasCatalogIdPackageNamePackageNameVersionsVersionGetRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response SchemasCatalogIdPackageNamePackageNameVersionsVersionGetOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 400:
		...
		case ct == "application/problem+json":
			...
			var response SchemasCatalogIdPackageNamePackageNameVersionsVersionGetBadRequest
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 500:
		...
		case ct == "application/problem+json":
			...
			var response SchemasCatalogIdPackageNamePackageNameVersionsVersionGetInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
