...
func decodeDeleteServiceResponse(resp *http.Response) (res DeleteServiceRes, _ error) {
	...
	case 403:
		...
		case ct == "application/problem+json":
			...
			var response DeleteServiceForbidden
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeGetPackageSchemaResponse(resp *http.Response) (res GetPackageSchemaRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response GetPackageSchemaOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 400:
		...
		case ct == "application/problem+json":
			...
			var response GetPackageSchemaBadRequest
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 500:
		...
		case ct == "application/problem+json":
			...
			var response GetPackageSchemaInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeGetServiceResponse(resp *http.Response) (res GetServiceRes, _ error) {
	...
	case 401:
		...
		case ct == "application/problem+json":
			...
			var response GetServiceUnauthorized
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 403:
		...
		case ct == "application/problem+json":
			...
			var response GetServiceForbidden
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 404:
		...
		case ct == "application/problem+json":
			...
			var response GetServiceNotFound
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 500:
		...
		case ct == "application/problem+json":
			...
			var response GetServiceInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeListServicesResponse(resp *http.Response) (res ListServicesRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response ListServicesOKApplicationJSON
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 401:
		...
		case ct == "application/problem+json":
			...
			var response ListServicesUnauthorized
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 403:
		...
		case ct == "application/problem+json":
			...
			var response ListServicesForbidden
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 500:
		...
		case ct == "application/problem+json":
			...
			var response ListServicesInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeSetServiceSuspendedResponse(resp *http.Response) (res SetServiceSuspendedRes, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		return &SetServiceSuspendedNoContent{}, nil
	case 401:
		// Code 401.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		if err != nil {
		...
		case ct == "application/problem+json":
			...
			var response SetServiceSuspendedUnauthorized
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 403:
		...
		case ct == "application/problem+json":
			...
			var response SetServiceSuspendedForbidden
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 404:
		...
		case ct == "application/problem+json":
			...
			var response SetServiceSuspendedNotFound
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 422:
		...
		case ct == "application/problem+json":
			...
			var response SetServiceSuspendedUnprocessableEntity
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 500:
		...
		case ct == "application/problem+json":
			...
			var response SetServiceSuspendedInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
